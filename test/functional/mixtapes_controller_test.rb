...
class MixtapesControllerTest < ActionController::TestCase
  ...
  test "should create mixtape" do
    assert_difference('Mixtape.count') do
      post :create, mixtape: { author: @mixtape.author, content: @mixtape.content, source: @mixtape.source, title: @mixtape.title }
    end
  ...
  test "should update mixtape" do
    put :update, id: @mixtape, mixtape: { author: @mixtape.author, content: @mixtape.content, source: @mixtape.source, title: @mixtape.title }
    assert_redirected_to mixtape_path(assigns(:mixtape))
  end
